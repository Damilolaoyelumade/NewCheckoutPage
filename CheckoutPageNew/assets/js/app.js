...
Frames.init("pk_sbox_fzspyszrkddxsgozkyqjbw4w7aw");
  ...
  processPayment(token)
    .then(result => {
      ...
      el.innerHTML =
        ...
        event.token +
        "</span><br>" +
        'API Response: <pre>' + result.response + '</pre>';
        */



      var approved = result.data.approved;
...
function onSubmit(event) {
  ...
  //var message =
 // 'Your Card has been charged : Transaction Successful  ';
